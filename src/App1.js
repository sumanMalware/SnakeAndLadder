...
const App1 = () => {
    ...
    const [turn, setturn] = useState("Player 2 Turn")
    const PlayerTurn = () => {    
        ...
        <div id='main'>
            ...
            <div id='container'>
                <div className="one">
                    ...
                    <div className="tv"><h2 id='turn'>Player 1 Turn</h2>
                    </div>
                </div>
                <div className="two">
                ...
                <div className="three">
                    ...
                    <div className="dicepoint2" ><img src={dice} alt="dice" id='diceimg' onClick={diceNumber} /></div>
                </div>
